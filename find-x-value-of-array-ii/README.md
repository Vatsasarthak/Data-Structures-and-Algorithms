...
Problem Link: https://leetcode.com/problems/find-x-value-of-array-ii/submissions/2150178226/?envType=daily-question&envId=2026-09-22  
Submitted At: 2026-09-22
...
<p>A <strong>prefix</strong> of an array is a <span data-keyword="subarray" class=" cursor-pointer relative text-dark-blue-s text-sm"></span> that starts from the beginning of the array and extends to any point within it.</p>

<p>A <strong>suffix</strong> of an array is a <span data-keyword="subarray" class=" cursor-pointer relative text-dark-blue-s text-sm"></span> that starts at any point within the array and extends to the end of the array.</p>
