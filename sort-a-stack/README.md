...
<p><span style="font-size: 18px;">Given a stack of integers <strong>st[]</strong>. Sort the stack in <strong>ascending order</strong> (smallest element at the bottom and largest at the top).</span></p>
